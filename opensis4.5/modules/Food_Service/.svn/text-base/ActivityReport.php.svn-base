...
DrawHeaderHome('<table><tr><td>'.PrepareDate($date,'_date').'</td><td>'. $type_select.': </td><td> '.$staff_select.' </td><td>'.$advanced_link,' : <INPUT type=submit value=Go class=btn_medium></td></tr></table>');
