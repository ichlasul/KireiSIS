...
if($auth->checkAdmin($profile, $staffId))
{
	...
	if(Discipline::addDisciplineAction($identifier,$perpetrator,$typeId,$startDate,$endDate,$specialEd,$zeroTol,$fullExpulsion,$shortExpulsion)){
