<?php
DrawBC(get_string('Food_Service', 'Modules')." > ".ProgramTitle());
...
if($_REQUEST['modfunc']=='delete')
{
	if($_REQUEST['tab_id']!='new')
	{
		if(DeletePrompt(get_string('mealItem', 'Food_Service/MenuItems')))
			DBQuery("DELETE FROM FOOD_SERVICE_MENU_ITEMS WHERE MENU_ID='$_REQUEST[tab_id]' AND MENU_ITEM_ID='$_REQUEST[menu_item_id]'");
	}
	else
		if(DeletePrompt(get_string('item', 'Food_Service/MenuItems')))
		{
...
if(!$_REQUEST['modfunc'])
{
	...
	if($_REQUEST['tab_id']!='new')
	{
		...
		$LO_columns = array('ITEM_ID'=>get_string('mealItem', 'Food_Service/MenuItems'),'ICON'=>get_string('icon', 'Food_Service/MenuItems'),'CATEGORY_ID'=>get_string('category', 'Food_Service/MenuItems'),'DOES_COUNT'=>get_string('includeInCounts', 'Food_Service/MenuItems'),'SORT_ORDER'=>get_string('sortOrder', 'Food_Service/MenuItems'));
		...
		$link['remove']['link'] = "Modules.php?modname=$_REQUEST[modname]&modfunc=delete&tab_id=$_REQUEST[tab_id]";
	...
	else
	{
		...
		if(User('PROFILE')=='admin' || User('PROFILE')=='teacher')
			$LO_columns = array('DESCRIPTION'=>get_string('itemDescription', 'Food_Service/MenuItems'),'SHORT_NAME'=>get_string('shortName', 'Food_Service/MenuItems'),'ICON'=>get_string('icon', 'Food_Service/MenuItems'),'SORT_ORDER'=>get_string('sortOrder', 'Food_Service/MenuItems'),'PRICE'=>get_string('studentPrice', 'Food_Service/MenuItems'),'PRICE_REDUCED'=>get_string('reducedPrice', 'Food_Service/MenuItems'),'PRICE_FREE'=>get_string('freePrice', 'Food_Service/MenuItems'),'PRICE_STAFF'=>get_string('usersPrice', 'Food_Service/MenuItems'));
		else
		{
			$LO_columns = array('DESCRIPTION'=>get_string('itemDescription', 'Food_Service/MenuItems'),'SHORT_NAME'=>get_string('shortName', 'Food_Service/MenuItems'),'ICON'=>get_string('icon', 'Food_Service/MenuItems'),'PRICE'=>get_string('studentPrice', 'Food_Service/MenuItems'));
			if(UserStudentID())
			{
				...
				if($discount=='Reduced')
					$LO_columns += array('PRICE_REDUCED'=>get_string('reducedPrice', 'Food_Service/MenuItems'));
				elseif($discount=='Free')
					$LO_columns += array('PRICE_FREE'=>get_string('freePrice', 'Food_Service/MenuItems'));
			}
			$LO_columns += array('PRICE_STAFF'=>get_string('usersPrice', 'Food_Service/MenuItems'));
		}
		...
		$singular = get_string('mealItem', 'Food_Service/MenuItems');
		$plural = get_string('mealItems', 'Food_Service/MenuItems');
	}
	...
	DrawHeader('',SubmitButton(get_string('save', 'Food_Service/MenuItems')));
	echo '<BR>';
	...
	echo '<CENTER>'.SubmitButton(get_string('save', 'Food_Service/MenuItems')).'</CENTER>';
	echo '</FORM>';
}
