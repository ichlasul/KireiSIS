...
/*else
{
$checkstudent="SELECT * FROM FOOD_SERVICE_STUDENT_ACCOUNTS WHERE student_id = '".UserStudentID()."'";
$countstudent = DBQuery($checkstudent);
if(!count($countstudent))
{
$sql = "INSERT INTO FOOD_SERVICE_ACCOUNTS (ACCOUNT_ID,BALANCE,TRANSACTION_ID) values('".UserStudentID()."','0.00','0')";
DBQuery($sql);

$sql = "INSERT INTO FOOD_SERVICE_STUDENT_ACCOUNTS (STUDENT_ID,DISCOUNT,BARCODE,ACCOUNT_ID) values('".UserStudentID()."','','','".UserStudentID()."')";
				DBQuery($sql);
...
{
$checkstudent="SELECT student_id FROM FOOD_SERVICE_STUDENT_ACCOUNTS WHERE student_id = '".UserStudentID()."'";
$countstudent = DBGet(DBQuery($checkstudent));
